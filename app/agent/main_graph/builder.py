...
def build_pmo_agent_graph(nodes: PMOMainGraphNodes):
    ...
    graph.add_node("resolve_domain_context", nodes.resolve_domain_context)
    ...
    graph.add_edge("resolve_current_flow", "resolve_domain_context")
    graph.add_edge("resolve_domain_context", "route_to_subgraph")
