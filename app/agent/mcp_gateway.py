...
class MCPGateway:
    ...
    async def _execute_read(
        ...
        for attempt in range(attempts):
            ...
            try:
                ...
                self._audit(spec, context, arguments, "success", latency_ms, limited)
                ...
                if attempt + 1 >= attempts:
                    latency_ms = int((time.perf_counter() - start) * 1000)
                    self._audit(spec, context, arguments, "timeout", latency_ms, None, "MCP_TIMEOUT")
                ...
                if attempt + 1 >= attempts:
                    ...
                    self._audit(
                        ...
                        latency_ms,
                        None,
                        getattr(exc, "code", "MCP_TRANSIENT_ERROR"),
                    )
    ...
    async def _execute_write(
        ...
        try:
            ...
            self._audit(spec, context, arguments, "error", latency_ms, None, "MCP_PERMANENT_ERROR")
